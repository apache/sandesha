...
Put sandesha2-policy-1.2.jar file that comes with the distribution to the <Axis2_webapp>/WEB-INF/lib directory.
...
sandesha2-client-constants-1.2.jar to your classpath. Otherwise you will have to add
