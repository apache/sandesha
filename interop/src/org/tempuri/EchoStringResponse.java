                           ...
                           */
                           public  org.tempuri.EchoStringResponseBodyType getEchoStringResponse(){
                            ...
                            /**
                               ...
                               * @param param EchoStringResponse
                               */
                               public void setEchoStringResponse(org.tempuri.EchoStringResponseBodyType param){
                                      ...
                                      if (localEchoStringResponse==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"echoStringResponse", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"echoStringResponse");
                                            }
            ...
            try {
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","echoStringResponse").equals(reader.getName())){
                                
                                      if ("true".equals(reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil"))){
                                          object.setEchoStringResponse(null);
                                          reader.next();
                                      }else{
                                    
                                        object.setEchoStringResponse(org.tempuri.EchoStringResponseBodyType.Factory.parse(reader));
                                    }
